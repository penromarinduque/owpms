...
class ApplicationHelper
{
    ...
    public function formatTimelineDescription(LtpApplicationProgress $log) {
        ...
        return '<span class="badge  bg-'.$color.'">'. $this->formatApplicationStatus($log->status) .'</span> &nbsp;'. $log->description . '<br><div class="bg-light p-2">'. (!in_array($log->remarks, ['', null, ' ', 'N/A', '<></>', '<p><br></p>']) ? $log->remarks : '<span class="text-muted">No Remarks</span>') . '</div>';
    }

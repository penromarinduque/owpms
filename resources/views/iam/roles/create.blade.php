...
<div class="container-fluid px-4">
    ...
    <form method="POST" action="{{ route('iam.roles.store') }}" class="card mb-4">
        @csrf
        ...
        <div class="card-body">
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('role_name') is-invalid @enderror" id="role_name" name="role_name" value="{{ old('role_name') }}" placeholder="Role Name" required>
                @error('role_name')
            ...
            <div class="mb-2">
                ...
                <textarea class="form-control @error('role_description') is-invalid @enderror" id="role_description" name="role_description" placeholder="Role Description" required>{{ old('role_description') }}</textarea>
                                    ...
                                    @foreach ($permissions->where('permission_group', $pg->permission_group) as $permission)
                                        <div class="mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission->permission_tag }}" id="permission{{ $permission->id }}">

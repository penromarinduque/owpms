...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ltp_applications', function (Blueprint $table) {
            ...
            $table->enum('application_status', ['draft', 'submitted', 'under-review', 'returned', 'resubmitted', 'accepted', 'payment-in-process', 'paid', 'for-inspection', 'approved', 'expired'])->default('draft');
